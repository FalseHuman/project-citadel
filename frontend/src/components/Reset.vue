          ...
          <v-card>
            <v-card-text class="pt-4">
              <div v-show="email_check!==true && token!==true">
                ...
                <p>Пожалуйста, укажите эл.почту, которую вы использовали при регистрации на сайте. На неё придёт код восстановления.</p>
                <v-form ref="form">
                  <formfield
                    type_input="input"
                    key_label="email"
                  ...
                  <v-layout justify-space-between>
                    <template>
                      <v-btn color="primary" @click="checkData('email')">Отправить</v-btn>
              ...
              <div v-show="email_check===true">
                ...
                <v-form ref="form">
                  ...
                  />
                  <v-layout justify-space-between>
                    <v-btn color="primary" @click="checkData('token')">Обновить</v-btn>
                    <a href="/login">Вернуться назад</a>
                  </v-layout>
                </v-form>
              </div>
    ...
    sendNewPassword() {
      $.post(
        this.$store.state.backend_url +
          "api/password/change_password/change_password/",
        this.data_user,
        data => {
