...
def get_vk_email(code: str):
    url = f'https://oauth.vk.com/access_token?client_id={settings.VK_CLIENT_ID }&client_secret={settings.VK_SECRET}&redirect_uri=http%3A%2F%2Fcrm.khazieff.cf%3A8002%2Fvk-callback&code={code}'
